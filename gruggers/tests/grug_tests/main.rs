...
mod game_fn_bindings {
	...
	#[allow(improper_ctypes)]
	unsafe extern "C" {
		safe fn game_fn_nothing              <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_magic                <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_initialize           <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_initialize_bool      <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_identity             <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_max                  <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_say                  <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_sin                  <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
		safe fn game_fn_cos                  <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_mega                 <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_get_false            <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_set_is_happy         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_mega_f32             <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_mega_i32             <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_draw                 <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_blocked_alrm         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_spawn                <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_spawn_d              <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_has_resource         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_has_entity           <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_has_string           <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_get_opponent         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_set_d                <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_get_os               <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_set_opponent         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_motherload           <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_motherload_subless   <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_offset_32_bit_f32    <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_offset_32_bit_i32    <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_offset_32_bit_string <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_talk                 <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_get_position         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_set_position         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_cause_game_fn_error  <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_call_on_b_fn         <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_store                <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_retrieve             <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_box_number           <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
        safe fn game_fn_print_csv            <'a>(data: NonNull<()>, state: &'a GrugState, values: *const GrugValue) -> GrugValue;
	}
